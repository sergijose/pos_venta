...
class ModeloCompras
{
  ...
  static public function mdlIngresarCompra($tabla, $datos)
  {
    ...
    $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(codigo, id_proveedor, idSucursal,id_usuario, productos, impuesto, neto, total, metodo_pago) VALUES (:codigo, :id_proveedor, :idSucursal,:id_usuario, :productos, :impuesto, :neto, :total, :metodo_pago)");
  ...
  static public function mdlEditarCompra($tabla, $datos)
  {
    ...
    $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_proveedor=:id_proveedor, id_usuario = :id_usuario, productos = :productos, impuesto = :impuesto, neto = :neto, total = :total, metodo_pago = :metodo_pago WHERE codigo=:codigo");
