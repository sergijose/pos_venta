...
<div class="content-wrapper">
  <section class="content-header">
    <h1><span><i class="fa fa-th"></i></span><strong>Gestion de Categorías</strong></h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    ...
    <div class="box box-success">
      ...
      <div class="box-header with-border">
        <button class="btn btn-flat btn-default" data-toggle="modal" data-target="#modalAgregarCategoria">
          Agregar categoría
        </button>
      </div>
...
<!--==================================== PIE DEL MODAL ======================================-->
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-flat btn-dark">Guardar categoría</button>
        </div>
        <?php
